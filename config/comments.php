...
return [
     ...
     */
    'permissions' => [
        'create-comment' => 'App\Policies\Comments\CommentPolicy@create',
        'delete-comment' => 'App\Policies\Comments\CommentPolicy@delete',
        'edit-comment' => 'App\Policies\Comments\CommentPolicy@update',
